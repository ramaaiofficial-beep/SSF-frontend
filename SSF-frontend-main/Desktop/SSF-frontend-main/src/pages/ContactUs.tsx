                  ...
                  <CardContent>
                    <div className="space-y-1.5 md:space-y-2">
                      <div className="flex items-center gap-1.5 md:gap-2">
                        ...
                        <a href="tel:+917813021766" className="text-muted-foreground hover:text-primary transition-colors text-sm md:text-base leading-tight">
                          Mobile: +91 781 302 1766
                        </a>
                      </div>
                      <div className="flex items-center gap-1.5 md:gap-2">
                        <Phone className="h-3 w-3 md:h-4 md:w-4 text-muted-foreground flex-shrink-0" />
                        <a href="https://wa.me/917813021766" className="text-muted-foreground hover:text-primary transition-colors text-sm md:text-base leading-tight">
                          WhatsApp: +91 781 302 1766
                        </a>
                      </div>
                    </div>
                  </CardContent>
