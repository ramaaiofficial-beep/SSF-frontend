                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <a href="tel:+917813021766" className="text-muted-foreground hover:text-primary transition-colors">
                          Mobile: +91 781 302 1766
                        </a>
                      </div>
                      <div className="flex items-center gap-2">
                        <Phone className="h-4 w-4 text-muted-foreground" />
                        <a href="https://wa.me/917813021766" className="text-muted-foreground hover:text-primary transition-colors">
